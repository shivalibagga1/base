define([
    ...
    var CarouselListView = {
        ...
        findActiveProduct: function() {
            ...
            for (var i = 0; i < $("#carousel-container #product-carousel-list li a").length; i++) {
                var currentElmnt = $("#carousel-container #product-carousel-list li a:eq(" + i + ")");
                if (currentElmnt.attr("href") === productCode) {
                    currentElmnt.parent("li").addClass("active");
                    break;
                }
            }
        },
